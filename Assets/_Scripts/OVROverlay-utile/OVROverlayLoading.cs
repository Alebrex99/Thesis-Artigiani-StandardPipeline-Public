...
namespace OculusSampleFramework
{
    ...
    ///
    /// </summary>
    public class OVROverlayLoading : MonoBehaviour
    {
        ...
        /// <summary>
        /// The camera used to render UI panels (SECOND CAMERA)
        /// </summary>
        public GameObject uiCamera;

        /// <summary>
        /// The parents of grouped UI panels (GEOMETRY TO RENDER)
        /// </summary>
